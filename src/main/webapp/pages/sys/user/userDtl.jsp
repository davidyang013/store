	...
	<script type="text/javascript">
		...
		function check(){
			...
			var param = "id=" + id + "&name=" + name + 
						"&pwd=" + pwd + cboMainChoice;
			if(optype == "update"){
				proxyRequest("<%=basePath%>sys/UserManagerAction!update.action", param);
			} else{
				proxyRequest("<%=basePath%>sys/UserManagerAction!insert.action", param);
			}
		}	
		...
		<div style="width:100%;" align="center">
			...
			<table class="editTable" width="100%">
				...
				<tr class="trMid">
					...
					<td class="tdInput">
						<input type="text" id="id" name="id" maxlength="32" value="${user.id}"/>
						<font color="red">*</font>
					</td>
					<td class="tdLabel">
						密码：
					...
					<td class="tdInput">
						<input type="password" id="pwd" name="pwd" maxlength="32" value="${user.pwd}"/>
						<font color="red">*</font>
					</td>
				</tr>
				<tr class="trMid">
					...
					<td class="tdInput" colspan="3">
						<input type="text" id="name" name="name" maxlength="32" value="${user.name}"/>
						<font color="red">*</font>
					</td>
				</tr>
			</table>
			<div class="scroll" style="height:150px;overflow-y: auto">
