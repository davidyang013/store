var oCalendarChs=new PopupCalendar("oCalendarChs"); //初始化控件时,请给出实例名称:oCalendarChs
	...
	oCalendarChs.oBtnTodayTitle="清空";
...
function CalendarInit() // /Create panel
{
	...
	htmlAll = "<div id='" + this.sDIVID
			+ "' style='display:none;z-index:100;position:absolute;width:" + this.Width
...
function getDateStringById(id, oInstance){
	var oInputSrc = document.getElementById(id);
	if (oInputSrc && oInstance) {
		CalendarDiv = document.all[oInstance.sDIVID];
		oInstance.oTaget = oInputSrc;
		CalendarDiv.style.pixelLeft = (CalendargetPos(oInputSrc, "Left") + 135);
